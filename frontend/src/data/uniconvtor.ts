...
export const cloneProducts: Product[] = [
  ...
  },
  {
    ...
    power: "4.6-6kW",
    description:
      "PV and battery all-in-one system with up to 120A charging and discharging current, diesel generator communication, UPS level switching, grid-connected operation, flexible scheduling, and plug-and-play expansion.",
    features: [
      "Up to 120A max charging/discharging current",
      "Support communication with diesel generator",
      "UPS level automatic switching under 10ms",
      "Support grid connected operation",
      "Flexible schedule the inverter charging and discharging time",
      "Support plug and play expansion",
    ],
    specs: {
      ProductModel: "ESS1-4.6K1P-02-LV-F-AIO / ESS1-5K1P-02-LV-F-AIO / ESS1-6K1P-02-LV-F-AIO",
      PVInput: "Max 580V, MPPT 120-520V, 2/2 MPPT strings",
      Battery: "Lithium Iron Phosphate 5.12kWh module, 51.2V rated voltage",
      ACOutput: "4.6kW / 5kW / 6kW",
      Protection: "IP65",
    },
    image: "/static/upload/image/20240722/1721614522517823.png",
    price: null,
    isNew: false,
    isFeatured: true,
  },
